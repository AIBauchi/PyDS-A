...
The Trie class provides methods for adding words to the trie, checking whether a specific
...
class Trie:
    """
        ...
        to their keys, here keys refers to the prefixes or the word which appear before any given charectar in the same
        sequence as they appear in the word to be stored. Each charectar is connected to the one which appears before it
         in the word.

        Methods:

            insert(word): Inserts a word in the trie.
            search_word(word): Searches for a word in the trie
            starts_with(substring): Searches for a substring in the beginning of the words in the trie.
