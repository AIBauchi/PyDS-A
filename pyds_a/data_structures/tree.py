...
class Tree:
    """
        ...
        A tree is a non-linear data structure in which the members are connected using references
        in a hierarchical manner in the form of parent and child node, where a child node  can be a
        parent node for other nodes.
